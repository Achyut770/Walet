...
const TokenInfo = ({ detail, currency }) => {
  return (
  <section classname="token-info pos-rel pt-200 pt-150">
    <div className="container">
      <div className="row">
        <div className="col-xl-8 offset-xl-4">
          <div className="token-info__title sec-title mb-95 text-center text-xl-start">
            <h5 className="sec-title__subtitle">PRESALE METAFROST TOKEN</h5>
            <h2 className="sec-title__title">
              PRESALE Token <br /> Details and Sale
              </h2>
          </div>
        </div>
      </div>
          ...
          <div className="token-info--info-wrap ul_li">
            <ul className="token-info__list token-info--start">
              ...
              <li>
                ...
                <span>1000Tokens / Transaction</span>
              </li>
            </ul>
    ...
    <div className="token-info_shape">
